    ...
    function test_constructor_HappyPath() public {
        ...
        verifier = new CSVerifier({
            ...
            gindices: ICSVerifier.GIndices({
                ...
                gIFirstBalancesNodePrev: pack(0x160000000000, 40),
                gIFirstBalancesNodeCurr: pack(0x160000000001, 40),
        ...
        public
    {
        ...
        verifier = new CSVerifier({
            ...
            gindices: ICSVerifier.GIndices({
                ...
                gIFirstBalancesNodePrev: pack(0x260000000000, 40),
                gIFirstBalancesNodeCurr: pack(0x260000000000, 40),
                gIFirstPendingConsolidationPrev: pack(0x3200000, 18),
...
contract CSVerifierWithdrawalTest is CSVerifierTestBase {
    ...
    function setUp() public {
        ...
        verifier = new CSVerifier({
            ...
            gindices: ICSVerifier.GIndices({
                ...
                gIFirstBalancesNodePrev: NULL_GINDEX,
                gIFirstBalancesNodeCurr: NULL_GINDEX,
    ...
    function test_processWithdrawalProof_RevertWhen_ValidatorNotWithdrawable()
        public
    {
        ...
        vm.expectRevert(ICSVerifier.ValidatorNotWithdrawable.selector);
        verifier.processWithdrawalProof(
            fixture.beaconBlock,
            fixture.witness,
            0,
...
contract CSVerifierConsolidationTest is CSVerifierTestBase {
        ...
        verifier = new CSVerifier({
            ...
            gindices: ICSVerifier.GIndices({
                ...
                gIFirstBlockRootInSummaryCurr: GIndices
                    .FIRST_BLOCK_ROOT_IN_SUMMARY_ELECTRA,
                gIFirstBalancesNodePrev: GIndices.FIRST_BALANCE_NODE_ELECTRA,
                gIFirstBalancesNodeCurr: GIndices.FIRST_BALANCE_NODE_ELECTRA,
                gIFirstPendingConsolidationPrev: GIndices
                    .FIRST_PENDING_CONSOLIDATION_ELECTRA,
                gIFirstPendingConsolidationCurr: GIndices
                    .FIRST_PENDING_CONSOLIDATION_ELECTRA
            }),
            firstSupportedSlot: Slot.wrap(0), // Any value less than the slots from the fixtures.
    ...
    function test_processConsolidationProof_HappyPath() public {
        ...
        withdrawals[0] = ValidatorWithdrawalInfo({
            ...
            exitBalance: fixture.balanceEther,
            slashingPenalty: 0
        });
    ...
    function _loadFixture() internal {
        ...
        cmd[0] = "node";
        cmd[1] = "test/fixtures/CSVerifier/consolidations.mjs";
    ...
    function setUp() public virtual {
        ...
        verifier = new CSVerifierTestable({
            ...
            gindices: ICSVerifier.GIndices({
                ...
                gIFirstBalancesNodePrev: pack(0x260000000000, 40),
                gIFirstBalancesNodeCurr: pack(0x360000000000, 40),
                gIFirstPendingConsolidationPrev: pack(0x3200000, 18),
    ...
    function setUp() public virtual {
        ...
        verifier = new CSVerifierTestable({
            ...
            gindices: ICSVerifier.GIndices({
                ...
                gIFirstBlockRootInSummaryPrev: NULL_GINDEX,
                gIFirstBlockRootInSummaryCurr: NULL_GINDEX,
                gIFirstBalancesNodePrev: pack(0x8, 4),
                gIFirstBalancesNodeCurr: pack(0x8, 4),
                gIFirstPendingConsolidationPrev: NULL_GINDEX,
                gIFirstPendingConsolidationCurr: NULL_GINDEX
            }),
            firstSupportedSlot: Slot.wrap(8192),
